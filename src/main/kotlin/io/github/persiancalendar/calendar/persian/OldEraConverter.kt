...
internal object OldEraConverter {
    ...
    init {
        ...
        val monthLength = listOf(
            /*1230*/ 31, 31, 32, 31, 31, 31, 30, 30, 29, 30, 30, 30,
            /*1231*/ 31, 31, 31, 31, 32, 31, 30, 30, 29, 30, 29, 30,
            /*1232*/ 30, 31, 32, 31, 31, 31, 30, 30, 30, 29, 30, 30,
            /*1233*/ 31, 31, 31, 31, 32, 31, 30, 30, 29, 30, 29, 30,
            /*1234*/ 31, 31, 32, 31, 31, 31, 30, 30, 29, 30, 30, 30,
            /*1235*/ 30, 31, 32, 31, 31, 31, 30, 30, 30, 29, 30, 30,
            /*1236*/ 30, 31, 32, 31, 31, 31, 30, 30, 30, 29, 30, 30,
            /*1237*/ 31, 31, 32, 31, 31, 31, 30, 30, 29, 29, 30, 30,
            ...
            /*1275*/ 31, 31, 31, 32, 31, 31, 30, 30, 29, 30, 30, 29,
